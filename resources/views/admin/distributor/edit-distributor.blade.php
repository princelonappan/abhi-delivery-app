        ...
        <form id="quickForm" action="{{ route('admin.distributor.update', $distributor->id) }}"  novalidate="novalidate" method="POST">
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="email" class="form-control" id="email" name="email" value="{{ $distributor->email }}"  placeholder="Email">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="inputPassword3" class="col-sm-2 col-form-label">Password</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="password" name="password" value="{{ $distributor->password }}"  placeholder="Password">
                    </div>
                </div>
                <div class="form-group row">
